        ...
        <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="#" className="flex items-center">
              <img src="presentix_logo.png" className="mr-3 h-6 sm:h-9" alt="Presentix Logo" />
            </a>
            ...
            >
              <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-6 lg:mt-0 ">
                {[
                  ...
                  <a href={url} className="rounded-lg  py-1 text-slate-700 font-medium hover:bg-slate-100 hover:text-slate-900">
                    {title}
                  </a>
                ))}
              </ul>
